...
//Se requiere tener un esquema de validación para los datos solicitados.
db.runCommand({
    collMod: "autor",
...
//Se necesita tener un índice por autor.
db.autor.getIndexes()
    ...
    validator: {
        $jsonSchema: {
            ...
            properties: {
                ...
                fechaPubli: {
                    bsonType: "date",
                    description: "El campo fechaPubli es requerido y debe ser de tipo cadena."
                },
                cuerpo: {
                    bsonType: "string",
                ...
                comentarios: {
                    ...
                    items: {
                        ...
                        properties: {
                            ...
                            fechaC: {
                                bsonType: "date",
                                description: "El campo fechaC es requerido y debe ser de tipo cadena."
                            },
                            calificacion: {
                                bsonType: "double",
...
//Se necesita tener un índice por noticia.
